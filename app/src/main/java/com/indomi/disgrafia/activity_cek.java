...
public class activity_cek extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        umur.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showDate();
            }
    ...
    private void showDate() {
        ...
        datePickerDialog = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                umur.setText(dateFormatter.format(newDate.getTime()));
            }
    ...
    private void simpanData() {
        ...
        aplotKiri.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(activity_cek.this, "Pesan Error : "+pesan, Toast.LENGTH_SHORT).show();
                loadingBar.dismiss();
            }
        }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(activity_cek.this, "Upload Gambar Tamnpak Kiri Berhasil", Toast.LENGTH_SHORT).show();
                Task<Uri> uriTask = aplotKiri.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(activity_cek.this, "Sukses Menerima Image Uri", Toast.LENGTH_SHORT).show();
        ...
        aplotKanan.addOnFailureListener(new OnFailureListener() {
            ...
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(activity_cek.this, "Upload Gambar Tamnpak Kanan Berhasil", Toast.LENGTH_SHORT).show();
        ...
        aplotAtas.addOnFailureListener(new OnFailureListener() {
            ...
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(activity_cek.this, "Upload Gambar Tamnpak Atas Berhasil", Toast.LENGTH_SHORT).show();
        ...
        aplotPegang.addOnFailureListener(new OnFailureListener() {
            ...
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(activity_cek.this, "Upload Gambar Tamnpak Pegang Berhasil", Toast.LENGTH_SHORT).show();
        ...
        aplotTulisan.addOnFailureListener(new OnFailureListener() {
            ...
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(activity_cek.this, "Upload Gambar Tamnpak Tulisan Berhasil", Toast.LENGTH_SHORT).show();
        ...
        ref.child(dataRandomKey).updateChildren(anakMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        {
                            loadingBar.dismiss();
                            Toast.makeText(activity_cek.this, "Data Anak Anda Berhasil Ditambahkan..", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(activity_cek.this, activity_dashboard.class);
